            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Kategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PreparationTime = table.Column<int>(type: "int", nullable: true),
                    PreparationTimeMH = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumberOfServings = table.Column<int>(type: "int", nullable: true),
                    CookingTime = table.Column<int>(type: "int", nullable: true),
                    CookingTimeMH = table.Column<string>(type: "nvarchar(max)", nullable: true),
